...
Para o backend da aplicação, deve ser executado o projeto Java encontrado na pasta "obiexploermobile" em sua IDE de preferência, mas a porta 8080 deve estar disponível para uso pelo servidor. 
